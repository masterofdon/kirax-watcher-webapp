...
class NotFoundChartWidget extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    fetch = () => {
        this.endpointsResultApiAdapter.get24HoursServerErrors("404")
            .then(function (data) {
                this.setState({
                    data: data.data
                })
            ...
            <div>
                <Spin spinning={loading}>
                    <DashboardChartWidget
                        headerText={'Kullanıcı Bulunamadı 404 - Not Found'}
                        headerSubText={'Kullanıcı Bulunamadı Hataları Grafiği'}
                    >
...
const connectedNotFoundChartWidget = connect(mapStateToProps)(NotFoundChartWidget);

export default connectedNotFoundChartWidget;