...
class NotAllowedChartWidget extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    fetch = () => {
        this.endpointsResultApiAdapter.get24HoursServerErrors("405")
            .then(function (data) {
                this.setState({
                    data: data.data
                })
            ...
            <div>
                <Spin spinning={loading}>
                    <DashboardChartWidget
                        headerText={'Kullanıcı Yetkisiz İşlem 405 - Not Allowed'}
...
const connectedNotAllowedChartWidget = connect(mapStateToProps)(NotAllowedChartWidget);

export default connectedNotAllowedChartWidget;